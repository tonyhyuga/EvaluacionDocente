(function() {
    ...
    angular
        .module('campoApp')
        .controller('RevisionEvaluativosController', RevisionEvaluativosController);

    RevisionEvaluativosController.$inject = ['$scope', '$state', 'RevisionEvaluativos', 'ParseLinks', 'AlertService', 'pagingParams', 'paginationConstants', 'GestorAmbitoService','LoginService',
    	'AniosEscolares','InstitucionesGestor'];

    function RevisionEvaluativosController ($scope, $state, RevisionEvaluativos, ParseLinks, AlertService, pagingParams, paginationConstants,GestorAmbitoService,LoginService,
    		AniosEscolares,InstitucionesGestor) {
        var vm = this;
...
//        }
        ...
        function cargarDropdrown(){
        	...
        	vm.dependencias=InstitucionesGestor.query();
        }
