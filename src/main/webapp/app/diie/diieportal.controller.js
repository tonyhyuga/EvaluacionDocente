(function() {
    ...
    DIIEController.$inject = ['$scope', '$state', 'Diie', 'ParseLinks', 'AlertService', 'pagingParams', 'paginationConstants', 'GestorAmbitoService','LoginService','downloadService',
    	'AniosEscolares','ReporteProfesorService','ReporteAlumnoService','Instituciones'];

    function DIIEController ($scope, $state, Diie, ParseLinks, AlertService, pagingParams, paginationConstants,GestorAmbitoService,LoginService,downloadService,
    		AniosEscolares,ReporteProfesorService,ReporteAlumnoService,Instituciones) {
        var vm = this;
