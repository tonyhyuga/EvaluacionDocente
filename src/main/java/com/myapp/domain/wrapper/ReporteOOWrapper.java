...
public class ReporteOOWrapper {

	private ReporteEvaluativoOyO reporte;
	/**
	 * 1-Admin_Evaluacion
	 * 2-Gestor
	 * 3-Profesor
	...
	public ReporteOOWrapper(){}
	
	public ReporteOOWrapper(ReporteEvaluativoOyO reporte,int tipo){
	...
	public ReporteEvaluativoOyO getReporte() {
		return reporte;
	}
	public void setReporte(ReporteEvaluativoOyO reporte) {
		this.reporte = reporte;
	}
...
//	}
	...
	public Blob convertStringToBlob(String value){
		Blob blob=null;
		if(value!=null){
